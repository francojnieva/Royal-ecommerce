...
const AboutRoyal = () => {
	...
	return (
		<section className='about-royal shadow-inner relative mb-3 px-3 h-[24rem] bg-cover bg-center flex justify-center items-center md:px-7 lg:px-12' style={{ backgroundImage }}>
